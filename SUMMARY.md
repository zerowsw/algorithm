...
* [Binary Indexed Tree & Segment Tree](binary-indexed-tree-and-segment-tree/README.md)
  * [Range Sum Query - Mutable](binary-indexed-tree-and-segment-tree/range-sum-query-mutable.md)
  * [Range Sum Query 2D - Mutable](binary-indexed-tree-and-segment-tree/range-sum-query-2d-mutable.md)
  * [Count of Smaller Numbers After Self](binary-indexed-tree-and-segment-tree/count-of-smaller-numbers-after-self.md)
  * [The Skyline Problem](binary-indexed-tree-and-segment-tree/the-skyline-problem.md)
  * [Reverse Pairs](binary-indexed-tree-and-segment-tree/reverse-pairs.md)
* [Trie](trie/README.md)
  * [Longest Word in Dictionary](trie/longest-word-in-dictionary.md)
  * [Prefix and Suffix Search](trie/prefix-and-suffix-search.md)
* [Facebook](facebook/README.md)
  ...
  * [Insert Interval](facebook/insert-interval.md)
  * [Two Sum III - Data structure design](facebook/two-sum-iii-data-structure-design.md)
  * [Path Sum III](facebook/path-sum-iii.md)
  * [Path Sum II](facebook/path-sum-ii.md)
  * [Backspace String Compare](facebook/backspace-string-compare.md)
  * [Wildcard Matching](facebook/wildcard-matching.md)
  * [Remove Invalid Parentheses](facebook/remove-invalid-parentheses.md)
  * [One Edit Distance](facebook/one-edit-distance.md)
  * [Inorder Successor in BST](facebook/inorder-successor-in-bst.md)
  * [Validate IP Address](facebook/validate-ip-address.md)
  * [Flatten Nested List Iterator](facebook/flatten-nested-list-iterator.md)
  * [Word Break II](facebook/word-break-ii.md)
  * [Binary Tree Postorder Traversal](facebook/binary-tree-postorder-traversal.md)
  * [Shuffle an Array](facebook/shuffle-an-array.md)
  * [Sparse Matrix Multiplication](facebook/sparse-matrix-multiplication.md)
  * [Convert Sorted List to Binary Search Tree](facebook/convert-sorted-list-to-binary-search-tree.md)
  * [Search in Rotated Sorted Array](facebook/search-in-rotated-sorted-array.md)
  * [Group Anagrams](facebook/group-anagrams.md)
  * [Longest Substring with At Least K Repeating Characters](facebook/longest-substring-with-at-least-k-repeating-characters.md)
  * [Rotate Array](facebook/rotate-array.md)
  * [Minimum Depth of Binary Tree](facebook/minimum-depth-of-binary-tree.md)
  * [Valid Number](facebook/untitled-1.md)
  ...
  * [All O\`one Data Structure](facebook/all-o-one-data-structure.md)
* [Google](google/README.md)
  ...
  * [Maximum Distance in Arrays](google/maximum-distance-in-arrays.md)
  * [Number Of Corner Rectangles](google/number-of-corner-rectangles.md)
  * [Count Complete Tree Nodes](google/count-complete-tree-nodes.md)
  * [Edit Distance](google/edit-distance.md)
  * [Maximal Rectangle](google/maximal-rectangle.md)
  * [Max Points on a Line](google/max-points-on-a-line.md)
  * [Largest Divisible Subset](google/largest-divisible-subset.md)
  * [Largest Rectangle in Histogram](google/largest-rectangle-in-histogram.md)
  * [Race Car](google/race-car.md)
  * [Shortest Path Visiting All Nodes](google/shortest-path-visiting-all-nodes.md)
  * [Bus Routes](google/bus-routes.md)
  * [Cheapest Flights Within K Stops](google/cheapest-flights-within-k-stops.md)
  * [Flatten a Multilevel Doubly Linked List](google/flatten-a-multilevel-doubly-linked-list.md)
  * [Longest Mountain in Array](google/longest-mountain-in-array.md)
  * [Contiguous Array](google/contiguous-array.md)
  * [Gas Station](google/gas-station.md)
  * [Minimum Cost to Hire K Workers](google/minimum-cost-to-hire-k-workers.md)
  * [Maximum Average Subarray II](google/maximum-average-subarray-ii.md)
  * [All Nodes Distance K in Binary Tree](google/all-nodes-distance-k-in-binary-tree.md)
  * [Serialize and Deserialize Binary Tree](google/serialize-and-deserialize-binary-tree.md)
  * [Image Overlap](google/image-overlap.md)
  * [Search in Rotated Sorted Array](google/search-in-rotated-sorted-array.md)
  * [Maximum Gap](google/maximum-gap.md)
  * [Contains Duplicates III](google/contains-duplicates-iii.md)
  * [Is Subsequence](google/is-subsequence.md)
  * [Number of Matching Subsequence](google/number-of-matching-subsequence.md)
  * [My Calendar I](google/my-calendar-i.md)
  * [My Calendar II](google/my-calendar-ii.md)
  * [My Calendar III](google/my-calendar-iii.md)
  * [K Empty Slot](google/k-empty-slot.md)
  * [Find Eventual Safe State](google/find-eventual-safe-state.md)
  * [Predict the Winner](google/predict-the-winner.md)
...
* [Microsoft](microsoft/README.md)
  ...
  * [Container With Most Water](microsoft/container-with-most-water.md)
  * [Coin Change](microsoft/coin-change.md)
...
* [Bloomberg](bloomberg/README.md)
  * [Sliding Window Maximum](bloomberg/sliding-window-maximum.md)
  * [Sort Characters By Frequency](bloomberg/sort-characters-by-frequency.md)
  * [Next Greater Element I](bloomberg/next-greater-element-i.md)
  * [Next Greater Element II](bloomberg/next-greater-element-ii.md)
* [Quip](quip/README.md)
  * [Consecutive Numbers Sum](quip/consecutive-numbers-sum.md)
* [Leet 7XX for Google](leet-7xx-for-google/README.md)
  * [Minimum ASCII Delete Sum for Two Strings](leet-7xx-for-google/minimum-ascii-delete-sum-for-two-strings.md)
  * [Subarray Product Less Than K](leet-7xx-for-google/subarray-product-less-than-k.md)
  * [Network Delay Time](leet-7xx-for-google/network-delay-time.md)
  * [Max Stack](leet-7xx-for-google/max-stack.md)
  * [Minimize Max Distance to Gas Station](leet-7xx-for-google/minimize-max-distance-to-gas-station.md)
* [高频](gao-pin.md)
* [时空复杂度分析问题](untitled.md)
* [特殊设计题或编程题](te-shu-she-ji-ti-huo-bian-cheng-ti.md)
